...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    public function _getFingerWithCount($customerId)
    {
        ...
        $this->getSelect()
			...
			->joinLeft(array('detail'=>$this->customer_images), 'main_table.id=detail.cust_id',array('COUNT(detail.cust_id) AS countFinger', 'image_name'))->where("main_table.customer_id=".$customerId)
			->group('main_table.id');
     ...
     public function _getAllFingerWithCount()
    {
        ...
        $this->getSelect()->joinInner(array('detail'=>$this->customer_images), 'main_table.id=detail.cust_id',array('COUNT(detail.cust_id) AS countFinger', 'image_name'))->group('main_table.id');
